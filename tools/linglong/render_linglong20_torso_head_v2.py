...
def render(qpos, filename, azimuth, elevation=5.0):
    ...
    viewer = rmv.RobotMotionViewer(
        ...
        camera_lookat_height_offset=0.10,
...
def main():
    ...
    print("=" * 100)
    print("LINGLONG TORSO / HEAD V2 VISUAL CHECK")
    print("=" * 100)
    ...
    # 偏正面：
    # 重点看 waist_yaw / head_yaw
    render(
        qpos,
        "linglong20_torso_head_v2_front.mp4",
        180.0,
        5.0,
    )
    ...
    # 侧面：
    # 重点看 waist_pitch / head_pitch
    render(
        qpos,
        "linglong20_torso_head_v2_side.mp4",
        90.0,
        5.0,
    )
