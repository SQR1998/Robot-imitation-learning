...
class OpenLoongArmSpatialRetargeter:
    def __init__(self, model: mj.MjModel, args: argparse.Namespace):
        ...
        # V3.0.1:
        # IK branch-continuity preference.
        #
        # arm_03 / arm_05 / arm_06 / arm_07 have more influence on
        # redundant arm orientation, so discourage unnecessary solution
        # switching more strongly on these joints.
        ...
        # These are NOT clipping limits. They only add optimization cost
        # when a solution unnecessarily approaches the physical limit.
    ...
    def solve(
        ...
        def residual(z: np.ndarray) -> np.ndarray:
            ...
            # V3.0.1 temporal continuity.
            #
            # This remains INSIDE the IK objective.
            # There is still no post-hoc dq clipping.
            ...
            # V3.0.1 soft joint-limit margin.
            #
            # Physical MuJoCo limits remain the hard least_squares bounds.
            # This additional residual only discourages solutions that sit
            # unnecessarily close to the bounds.
